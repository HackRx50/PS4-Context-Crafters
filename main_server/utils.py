...
def save_and_verify_docs(
        file_content_type: str, 
        file_name: str, 
        file_content) -> str:

    if file_content_type not in ["application/json",
                                "application/pdf", 
                                 "application/msword", 
        ...
        raise HTTPException(status_code=400, detail="Please upload a PDF, DOC, DOCX, PPT or PPTX file !!!")
